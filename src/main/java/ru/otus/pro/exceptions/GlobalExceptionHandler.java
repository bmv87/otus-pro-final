package ru.otus.pro.exceptions;
...
import ru.otus.pro.common.ValidationErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleHWValidationException(
        ...
        var errorVm = new ValidationErrorDTO();
    ...
    private void fillAnyOtherExceptionVm(ErrorDTO errorVm, Throwable ex) {
        String stackTrace = "";
        if (needStack) {
    ...
    private void fillServiceExceptionVm(ErrorDTO errorVm, ServiceException ex) {
        String stackTrace = "";
        if (needStack) {
            stackTrace = Arrays.stream(ex.getStackTrace())
                    .map(StackTraceElement::toString)
